      ...
      <div class="container text-center">
        <div class="row">
          ...
          <div class="col-md-3 col-12">
            <h4>Patners</h4>
            <p className="para1">
              Whether it’s cross-border payments, supply chain challenges, or
              raising capital, blockchain enables enterprises operating in
              multiple markets to exchange information and assets more securely
              and cost-effectively. Your challenge though is how to implement it
              simply while protecting your existing IT investments.
            </p>
          </div>
          <div class="col-md-3 col-12">
            <h4>Developers</h4>
